...
namespace Models.Models
{
    public class PurchaseInvoiceDetails
    {
        ...
        [ForeignKey(nameof(purchaseInvoiceHeader))]
        ...
        public PurchaseInvoiceDetails(int id,int purchaseInvoiceId,int moslsel,int itemid,decimal quantity,int unitid,decimal price
        ...
        public PurchaseInvoiceDetails Clone()
        {
